...
Test konukları: **GLM 5.2**, **Opus 4.8**, **moonshotai/kimi-k2.7-code**.
...
| [**moonshotai/kimi-k2.7-code**](runs/moonshotai-kimi-k2.7-code__applixus/scorecard.md) | 72 | 88 | 43 | 80 | **70.75** | [scorecard](runs/moonshotai-kimi-k2.7-code__applixus/scorecard.md) · [canlı demo](https://kimi-2-7-code.applixus.com/) |
...
> **moonshotai/kimi-k2.7-code** · composite **70.75/100** = `(72 + 88 + 43 + 80) / 4` (**tek-run**). PageSpeed = Lighthouse Performans
> (mobil **88** / masaüstü **97**). Teknik/UI/Okunabilirlik = Codex (nötr, tek run — 3-run medyan henüz yapılmadı).
> Maliyet: **$1.45**. Gerekçe: [scorecard.md](runs/moonshotai-kimi-k2.7-code__applixus/scorecard.md).
> Canlı demo: <https://kimi-2-7-code.applixus.com/> · rebuild kaynağı: [`runs/moonshotai-kimi-k2.7-code__applixus/site/`](runs/moonshotai-kimi-k2.7-code__applixus/site/).
> **Not:** UI (43) ve PageSpeed (88) eksenlerinde ilk iki modelin belirgin altında; 3-run medyana geçildiğinde sıralama değişebilir.
